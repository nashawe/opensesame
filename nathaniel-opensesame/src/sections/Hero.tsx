    ...
    >
      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-2xl">
                I’m a CS undergrad at UW–Madison. I build full-stack platforms
                and simulation engines. Now, I want to use those skills to help
                OpenSesame democratize workforce training.
              </p>
            </div>

            <div className="flex flex-wrap gap-2">
              <Badge variant="brand" className="py-1.5 px-3 text-sm">
                Built a Neural Net from Scratch
              </Badge>
              <Badge variant="outline" className="py-1.5 px-3 text-sm">
                FastAPI + React
              </Badge>
              <Badge variant="outline" className="py-1.5 px-3 text-sm">
                Event Systems (1k+ events/min)
              </Badge>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Button href="/#ai-demo" size="lg" className="group">
                Try the AI Demo
          ...
          {/* Right Column: "What I Ship" Card */}
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="relative hidden md:block" // Hidden on small mobile to save space
          >
            <div className="relative z-10 bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
              ...
              <ul className="space-y-4">
                <ListItem
                  ...
                  desc="I like systems that are easy to debug."
                />
                <ListItem
                  icon={<Layers className="w-5 h-5 text-slate-400" />}
                  title="Interactive UX"
                  desc="Tools should be fun to use."
                />
                <ListItem
                  icon={<Terminal className="w-5 h-5 text-slate-400" />}
                  title="Clear Docs"
                  desc="I write code that explains itself."
                />
              </ul>
            </div>
...
const ListItem = ({
  ...
  <li className="flex gap-4 items-start p-2 rounded-lg hover:bg-slate-50 transition-colors">
